...
class Category(MPTTModel): 
    """
    Category Model implimented with MPPT
    """
...
class ProductType(models.Model):
    """
    ProductType Table will provide a list of different types of products that are for sale.
    """
...
class ProductSpecificationValue(models.Model):
    """
    The Product Specification Value table holds each of the product individual specification or bespoke features.
    """
